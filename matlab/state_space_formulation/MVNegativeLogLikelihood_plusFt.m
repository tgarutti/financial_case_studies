...
global predictedxi z PCOrtec_window
...
[~,~,predictedxi,predictedP] = MVKalmanFilter_plusFt(parameter_vector,y);
...
for t=3:T
    ...
    mu(:,t)      = Q*predictedxi(:,t)+H1*z(:,t-1)+H2*z(:,t-2)+H3*PCOrtec_window(:,t);
