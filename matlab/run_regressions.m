...
F(:,:,i) = [100*inflation(window(1):window(end-1))';...
    100*inflation(window(2):window(end))';...
    100*outputGap(window(1):window(end-1))';...
    100*outputGap(window(2):window(end))'; Lt(window(1):window(end-1))';...
    St(window(1):window(end-1))'; residualSt];